        ...
        {loading ? (
          ...
          <div className='bodybg'>
            {/* <div className='container mx-auto pt-5 px-4 md:px-[99px]'>
              <Link href={'/product'}>
							<button className="flex items-center justify-center gap-2 rounded-full border-amber-400 font-bold pr-5 pl-3 py-2 border-0 bg-[#d4983d] hover:bg-amber-600 hover:border-amber-600 text-white transition-all ease-out duration-300"> <MdOutlineKeyboardDoubleArrowLeft className="text-[21px]" /> Back </button>
              </Link>
            </div> */}
                                ...
                                <div className="flex flex-wrap">
                                    ...
                                    <div className="w-full md:w-5/12 ">
                                        ...
                                        <div className="pl-0 md:pl-8 pt-8 md:pt-0">
                                            ...
                                            <div className="pt-6 md:pt-10 flex gap-2 flex-wrap">
                                                <div className=""> 
                                                {
